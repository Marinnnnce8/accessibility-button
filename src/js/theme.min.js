...
function textChange(textContent, textClass) {
...
highContrastButton.addEventListener("click", function () {
  filterPage(pageContent, highContrastClass);
});

negativeContrastButton.addEventListener("click", function () {
  filterPage(pageContent, negativeContrastClass);
});
...
linksUnderlineButton.addEventListener("click", function () {
  textChange(pageContent, linksUnderlineClass);
});

readableFontButton.addEventListener("click", function () {
  textChange(pageContent, readableFontClass);
});
