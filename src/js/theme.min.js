...
var accessibilityButton = document.getElementsByClassName(
  ...
  resizeButtonFontPlus = "js-resize-plus",
  resizeButtonFontMinus = "js-resize-minus",
  ...
  lightBackgroundButton = document.getElementsByClassName("js-light-background")[0],
  lightBackgroundClass = "accessibility-light-background",
  linksUnderlineButton = document.getElementsByClassName("js-links-underline")[0],
...
function resizeFont() {
  ...
  if (this.classList.contains(resizeButtonFontPlus)) {
    if (incrementNum < 200) {
      incrementNum += 10;
    }
...
function filterPage(filterContent, filterClass) {
